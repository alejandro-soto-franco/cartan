...
cartan-homog        mean-field + full-field homogenisation, cross-validated, SPD-manifold-native
cartan-homog-valid  numerical fixture validation harness + capstone pipeline test (not published)
