...
fn main() {
    let out_path = std::env::args()
        .nth(1)
        .unwrap_or_else(|| "benchmarks/results/pipeline_capstone.jsonl".into());
    ...
    writeln!(
        wr,
        r#"{{"stage":1,"name":"mori_tanaka_at_depths","n_calls":{},"ns":{}}}"#,
        depths.len(),
        ns_stage1
    )
    .unwrap();
    ...
    writeln!(
        wr,
        r#"{{"stage":2,"name":"spd_geodesic_interp","ns":{},"mid_eig_min":{},"mid_eig_max":{}}}"#,
        ns_stage2,
        eig_mid
            .eigenvalues
            .iter()
    ...
    writeln!(
        wr,
        r#"{{"stage":3,"name":"slab_problem_setup","resolution":6,"ns":{}}}"#,
        ns_stage3
    )
    .unwrap();
    ...
    writeln!(
        wr,
        r#"{{"stage":4,"name":"darcy_solve","n_tets":{},"ns":{},"k_eff_zz":{}}}"#,
        sol.mesh.n_simplices(),
        ns_stage4,
        sol.k_eff_macro[(2, 2)]
    )
    .unwrap();
    ...
    writeln!(
        wr,
        r#"{{"stage":5,"name":"hausdorff_gate","n_refined":{},"n_analytic":{},"d_h":{},"ns":{}}}"#,
        refined.len(),
        analytic.len(),
        d_h,
        ns_stage5
    ...
    writeln!(
        wr,
        r#"{{"stage":"total","name":"end_to_end","ns":{},"ms":{}}}"#,
        ns_total,
        ns_total as f64 / 1.0e6
    )
    .unwrap();

    wr.flush().unwrap();
    eprintln!(
        "Pipeline capstone: {} ms total, {} stages timed",
        ns_total / 1_000_000,
        6
    );
}
